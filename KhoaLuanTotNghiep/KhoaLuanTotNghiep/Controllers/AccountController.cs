...
namespace KhoaLuanTotNghiep_BackEnd.Controllers
{
    ...
    {
        private readonly SignInManager<UserAuth> _signInManger;
        private readonly UserManager<UserAuth> _userManager;
        public AccountController(SignInManager<UserAuth> signInManger, UserManager<UserAuth> userManager)
        {
        ...
        public async Task<IActionResult> ChangePasswordFirstAsync([FromBody] ChangePassWordFirstModel passWordFirstModel)
        {
            ...
            var defaultPass = AccountHelper.GenerateAccountPass(user.UserName, user.DateOfBirth);
